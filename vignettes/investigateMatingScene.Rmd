...
```{r}
plotScene(eelr, "t")
plotScene(eelr, "t", sub = 'all', drawQuartiles = FALSE, label.cex = 0.5)
```
...
```{r}
plotScene(eelr, c('s','t'), sub = focalPlants, N = 4, label.cex = 0.5)
```
...
eSum <- matingSummary(eelr, as.data.frame = T)
